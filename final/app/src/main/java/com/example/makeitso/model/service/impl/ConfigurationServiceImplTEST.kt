...
class ConfigurationServiceImplTEST @Inject constructor() : ConfigurationServiceTEST {
  ...
  override suspend fun fetchConfigurationTEST(): Boolean =
    trace(FETCH_CONFIG_TRACE) { remoteConfig.fetchAndActivate().await() }

  override val isShowPlayerEditButtonConfig: Boolean
    get() = remoteConfig[SHOW_PLAYER_EDIT_BUTTON_KEY].asBoolean()

  companion object {
    private const val SHOW_PLAYER_EDIT_BUTTON_KEY = "show_task_edit_button"
